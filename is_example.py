...
#####
# This is a custom 'getting started' script, made with care for dxjones00@yahoo.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="lmF06smOcuvDgxl2iovSvrDTtnTBzlPn")
